...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "A síntese do equilíbrio. 32 unidades exclusivas de 172 m² a 298 m² em Mont'Serrat, Porto Alegre. Pré-lançamento.",
    heroImageId: 'synthe-hero',
    galleryImageIds: [],
    floorPlanImageIds: [],
    location: {
      address: "Rua Pedro Ivo, 550 — Mont'Serrat, Porto Alegre",
      mapImageId: 'map-placeholder',
    },
    videoUrl: '',
    availability: [],
