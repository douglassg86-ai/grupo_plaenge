...
const lotData = {
    ...
    'Quadra E': {'E L9': { price: '659.347,79', area: '323,63', type: 'LAGO' }, 'E L10': { price: '598.950,73', area: '294,33', type: 'LAGO' }, 'E L19': { price: '727.130,45', area: '356,9', type: 'LAGO' }, 'E L20': { price: '645.656,80', area: '316,91', type: 'LAGO' }},
    'Quadra F': {'F L7': { price: '625.880,51', area: '290,2', type: 'LAGO' }, 'F L8': { price: '633.709,41', area: '293,83', type: 'LAGO' }, 'F L10': { price: '671.214,79', area: '311.11', type: 'LAGO' }, 'F L11': { price: '678.396,67', area: '314,55', type: 'LAGO' }, 'F L12': { price: '679.367,20', area: '315.00', type: 'LAGO' }, 'F L20': { price: '500.592,79', area: '232.11', type: 'LAGO' }, 'F L21': { price: '670.416,81', area: '310,85', type: 'LAGO' }},
    'Quadra G': {'G L9': { price: '601.024,82', area: '264,06', type: 'LAGO' }},
    'Quadra H': {'H L2': { price: '780.349,37', area: '406,86', type: 'LAGO' }, 'H L3': { price: '751.848,18', area: '392', type: 'LAGO' }, 'H L4': { price: '731.518,64', area: '369,89', type: 'LAGO' }, 'H L5': { price: '705.351,17', area: '346.21', type: 'LAGO' }, 'H L6': { price: '702.885,98', area: '345.00', type: 'LAGO' }, 'H L10': { price: '560.836,59', area: '287,93', type: 'LAGO' }},
    'Quadra I': {'I L1': { price: '614.159,36', area: '301,45', type: 'LAGO' }, 'I L19': { price: '506.385,09', area: '264,02', type: 'LAGO' }, 'I L20': { price: '585.942,91', area: '305,5', type: 'LAGO' }},
    ...
    'Quadra N': {'N L3': { price: '589.539,76', area: '273,35', type: 'LAGO' }, 'N L18': { price: '515.322,88', area: '268,68', type: 'CANTO/LAGO' }, 'N L19': { price: '486.649,76', area: '270.57', type: 'CANTO/LAGO' }, 'N L20': { price: '481.307,89', area: '267,6', type: 'CANTO/LAGO' }}
};
