    ...
    <div className="bg-background min-h-screen">
      ...
      <div className="container relative z-10 -mt-8 pb-16 space-y-2">
        ...
        <div className="bg-card rounded-2xl p-8 md:p-10 space-y-4">
          ...
          <h2 className="font-display text-3xl text-foreground">Conheça o VERDANT</h2>
          <div className="aspect-video w-full overflow-hidden rounded-xl border">
            <iframe src="https://www.youtube.com/embed/O59Ha1QWyJA" title="VERDANT" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen className="w-full h-full" style={{ border: 0 }} />
          </div>
        </div>
